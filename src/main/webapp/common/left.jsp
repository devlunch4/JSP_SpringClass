...
<ul class="nav nav-sidebar">
	<li class="active"><a
		href="${pageContext.request.contextPath}/main.jsp">Main <span
			class="sr-only">(current)</span></a></li>
	<li class="active"><a href="${pageContext.request.contextPath}/allUser">전체사용자</a></li>
	<li class="active"><a
		href="${pageContext.request.contextPath}/pagingUser">전체사용자페이징리스트</a></li>
...
kr.or.ddit.user.controller.PaginUser.java 
 --%>
	<li><hr></li>
	<!--  -->
	<li class="active"><a href="${pageContext.request.contextPath}/allEmp">EMP</a></li>
	<li class="active"><a
		href="${pageContext.request.contextPath}/pagingEmp">EMP Paging List</a></li>
	<%--
